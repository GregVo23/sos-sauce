...
<Header @ChangeMode="ChangeMode($event)"></Header>
  ...
  <main class="min-h-full h-screen bg-cover bg-top sm:bg-top" style="background-image: url('http://www.localhost:8000/storage/meals/detail/intro.jpg'); background-position: center; background-size: cover; background-repeat: no-repeat;">
