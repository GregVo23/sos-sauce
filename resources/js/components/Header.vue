            ...
            >
                ...
                >
                    ...
                    <div class="min-w-0 flex-1 md:px-8 lg:px-0 xl:col-span-6">
                        <div
                            class="flex items-center px-6 py-8 md:max-w-xl md:mx-auto lg:max-w-none lg:mx-0 xl:px-0"
                        >
                            <div
                                :class="[
                                    dark ? 'bg-gray-600' : 'bg-white',
                            ...
                            >
                                ...
                                <div class="relative">
                                    ...
                                    <input
                                        ...
                                        id="search"
                                        name="search"
                                        class="block w-full bg-white border border-gray-300 rounded-md py-2 pl-10 pr-3 text-sm placeholder-gray-500 focus:outline-none focus:text-gray-900 focus:placeholder-gray-400 focus:ring-1 focus:ring-red-500 focus:border-red-500 sm:text-sm"
                                ...
                                >
                                    <div v-if="showFilter" class="mt-2">
                                        ...
                                        <fieldset class="mt-2">
                                            ...
                                            >
                                                <div
                                                    v-for="filterSearch in filterSearchs"
                                                    :key="filterSearch.id"
                    ...
                    >
                        <!-- Mobile menu button -->
                        <PopoverButton
                            class="-mx-2 rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-red-500"
                        >
                        ...
                        <div class="flex-shrink-0">
                            <Switch
                                ...
                                :class="[
                                    ...
                                    'relative inline-flex flex-shrink-0 h-6 w-11 border-2 border-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300',
                                ]"
                            >
                            ...
                            <div>
                                <MenuButton
                                    :class="[
                                        ...
                                        'rounded-full flex focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500',
                                    ]"
                                >
            ...
            <PopoverPanel as="nav" class="lg:hidden" aria-label="Global">
                ...
                <div class="border-t border-gray-200 pt-4 pb-3">
                    ...
                    >
                        ...
                        <button
                            type="button"
                            class="ml-auto flex-shrink-0 bg-white rounded-full p-1 text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
                        >
...
export default {
    ...
    methods: {
        darkmode() {
            window.sessionStorage.getItem("dark") == "true"
